...
class Jeu () :
    ...
    def __init__(self):
        # GRAPHIQUE :
        self.fenetre= tk.Tk()
        self.canvas= tk.Canvas(self.fenetre, width=1000, height=700, bg="light blue")
        self.canvas.pack()
    ...
    def placerPokemon(self, gl, gc, l, c):
        ...
        self.pokemons_places[gl][gc][l][c] = (self.joueur, "bulbasaur")

        #on le place graphiquement
        image = tk.PhotoImage(file = "Partie Pokemon/Photos Pokemon/Pokemons/1-bulbasaur.png")
